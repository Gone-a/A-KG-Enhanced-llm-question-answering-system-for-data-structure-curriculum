...
test_samples = [
    ...
    # ==============================================================================
    # 新增意图 3: find_entity_definition
    # 模式: 询问 [实体] 的定义、原理或描述
    # ==============================================================================
    ("什么是图的遍历？", "find_entity_definition"),
    ("Dijkstra", "find_entity_definition"),
    ("介绍一下排序", "find_entity_definition"),
    ("请解释一下什么叫做“堆”", "find_entity_definition"),
    ("我想知道关于“栈”的知识", "find_entity_definition"),

    # ==============================================================================
    # 意图 4: other
    # 模式: 不符合以上模式的所有其他问题（特别是边界和模糊情况）
    # ==============================================================================
    ("我想了解关于数组和链表的一切", "other"), # 提及两个实体，但问题模糊，不属于关系查询
    ("你觉得学习数据结构最快的方法是什么？", "other"), # 主观开放性问题 [cite: 40]
    ("今天晚上台北天气好吗？", "other"), # 领域外闲聊 [cite: 40]
    ("现在是晚上11点多了吧？", "other"), # 领域外闲聊 [cite: 40]
    ("谢谢你的帮助", "other"), # 闲聊 [cite: 40]
]
