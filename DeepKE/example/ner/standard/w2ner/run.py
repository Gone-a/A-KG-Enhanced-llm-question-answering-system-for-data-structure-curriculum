...
def main(cfg):
    ...
    print("train_examples是否为空:", train_examples is None)
    print("datasets[0]是否为空:", datasets[0] is None)
    # 在 main 函数中，加载 datasets 后添加
    print("datasets 长度:", len(datasets))       # 应为 3（train, dev, test）
    print("datasets[0] 长度:", len(datasets[0]))  # 应为训练样本数（非空）
